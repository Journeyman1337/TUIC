...
TEST_CASE("tuiDetailFlagToString") {
    ...
    REQUIRE(std::string(tuiDetailFlagToString(TUI_DETAIL_FLAG_LAYOUT_FREE)) == std::string(TO_STRING(TUI_DETAIL_FLAG_LAYOUT_FREE)));
}
...
TEST_CASE("tuiStringToDetailFlag") {
    ...
    REQUIRE(tuiStringToDetailFlag(TO_STRING(TUI_DETAIL_FLAG_LAYOUT_FREE)) == TUI_DETAIL_FLAG_LAYOUT_FREE);
}
