...
TEST_CASE("tuiErrorCodeToString") {
    ...
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_INVALID_BATCH_PIXEL_DIMENSIONS)) == std::string(TO_STRING(TUI_ERROR_INVALID_BATCH_PIXEL_DIMENSIONS)));
...
TEST_CASE("tuiStringToErrorCode") {
    ...
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_INVALID_BATCH_PIXEL_DIMENSIONS)) == TUI_ERROR_INVALID_BATCH_PIXEL_DIMENSIONS);
