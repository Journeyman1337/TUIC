...
TEST_CASE("tuiErrorCodeToString") {
    ...
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_BATCH_OVERFLOW)) == std::string(TO_STRING(TUI_ERROR_BATCH_OVERFLOW)));
    ...
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_INVALID_BATCH_FUNCTION)) == std::string(TO_STRING(TUI_ERROR_INVALID_BATCH_FUNCTION)));
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_INVALID_BATCH_GLYPH_PIXEL_DIMENSIONS)) == std::string(TO_STRING(TUI_ERROR_INVALID_BATCH_GLYPH_PIXEL_DIMENSIONS)));
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_INVALID_BATCH_MAX_TILE_COUNT)) == std::string(TO_STRING(TUI_ERROR_INVALID_BATCH_MAX_TILE_COUNT)));
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_INVALID_BATCH_VIEWPORT_PIXEL_DIMENSIONS)) == std::string(TO_STRING(TUI_ERROR_INVALID_BATCH_VIEWPORT_PIXEL_DIMENSIONS)));
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_INVALID_BATCH_TILE_DIMENSIONS)) == std::string(TO_STRING(TUI_ERROR_INVALID_BATCH_TILE_DIMENSIONS)));
    ...
    REQUIRE(std::string(tuiErrorCodeToString(TUI_ERROR_NULL_GRID_SHAPE_ITERATOR)) == std::string(TO_STRING(TUI_ERROR_NULL_GRID_SHAPE_ITERATOR)));
...
TEST_CASE("tuiStringToErrorCode") {
    ...
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_BATCH_OVERFLOW)) == TUI_ERROR_BATCH_OVERFLOW);
    ...
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_INVALID_BATCH_FUNCTION)) == TUI_ERROR_INVALID_BATCH_FUNCTION);
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_INVALID_BATCH_GLYPH_PIXEL_DIMENSIONS)) == TUI_ERROR_INVALID_BATCH_GLYPH_PIXEL_DIMENSIONS);
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_INVALID_BATCH_MAX_TILE_COUNT)) == TUI_ERROR_INVALID_BATCH_MAX_TILE_COUNT);
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_INVALID_BATCH_VIEWPORT_PIXEL_DIMENSIONS)) == TUI_ERROR_INVALID_BATCH_VIEWPORT_PIXEL_DIMENSIONS);
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_INVALID_BATCH_TILE_DIMENSIONS)) == TUI_ERROR_INVALID_BATCH_TILE_DIMENSIONS);
    ...
    REQUIRE(tuiStringToErrorCode(TO_STRING(TUI_ERROR_NULL_GRID_SHAPE_ITERATOR)) == TUI_ERROR_NULL_GRID_SHAPE_ITERATOR);
