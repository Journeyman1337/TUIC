...
{
    TuiBoolean ctrl_mod = tuiKeyboardKeyboardModContainsMod(mod, TUI_MOD_CONTROL);
...
int main()
{
    ...
    sAtlas = tuiAtlasCreateCodepageGrid(atlas_image, blend_mode);
    ...
    sWindow = tuiWindowCreate(window_width, window_height, window_title, NULL);
