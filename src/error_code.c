...
const char* kTui_Error_Invalid_Key_Description = "The TuiKeyboardKey is invalid.";
const char* kTui_Error_Invalid_Key_Mod_Description = "The TuiKeyboardKeyMod is invalid.";
